...
@ExceptionHandler
public ResponseEntity<Object> handleDietPlanException(NutritionIdException ex, WebRequest request){
	NutritionIdExceptionResponse dietPlanExceptionResponse =  new NutritionIdExceptionResponse(ex.getMessage());
